...
const translations = {
    EN: {
      ...
      "vision-text": "To be the first choice for travelers by consistently providing innovative and reliable, seamless travel solutions.",
      "mission-title": "Our Mission",
      "mission-text": "We aim to revolutionize the travel experience by offering personalized services, leveraging industry partnerships, and exceeding customer expectations every step of their journey.",
    ...
    AR: {
      ...
      "vision-title": "رؤيتنا",
      "vision-text": "أن نكون الخيار الأول للمسافرين من خلال تقديم حلول سفر مبتكرة وموثوقة وسلسة.",
      "mission-title": "مهمتنا",
      "mission-text": "نهدف إلى إعادة تعريف تجربة السفر من خلال تقديم خدمات مخصصة، والاستفادة من الشراكات الصناعية، وتجاوز توقعات العملاء في كل خطوة من رحلتهم.",
